...
def main(args):
    ...
    # traindataset = Zhang('/media/administrator/1305D8BDB8D46DEE/jhu/ZhangLabData/CellData/chest_xray/train', 
    #                 train=True, img_size=(128, 128), enable_transform=True)
    # valdataset = Zhang('/media/administrator/1305D8BDB8D46DEE/jhu/ZhangLabData/CellData/chest_xray/test', train=False, 
    ...
    # chexpert
    traindataset = ChexPert('/media/administrator/1305D8BDB8D46DEE/jhu/CheXpert-v1.0-small/CheXpert-v1.0-small/train_256_'+'pa', 
    ...
    # valdataset = ChexPert('/media/administrator/1305D8BDB8D46DEE/jhu/CheXpert-v1.0-small/CheXpert-v1.0-small/val_256_'+'pa', train=False, 
    #                 img_size=(128, 128), full=True, data_type='pa')
    train_loader = torch.utils.data.DataLoader(traindataset, batch_size=32, shuffle=True, num_workers=0, drop_last=True)
