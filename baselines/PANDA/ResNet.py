# The code is adapted from https://https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
...
def resnet50(pretrained=False, progress=True, **kwargs):
    ...
    model_file = '/cs/labs/peleg/talreiss/resnet50_places365.pth.tar'
    if pretrained:
