...
def get_resnet_model(resnet_type=152):
    ...
    """
    if resnet_type == 18:
        return ResNet.resnet18(pretrained=False, progress=True)
    elif resnet_type == 50:
        return ResNet.wide_resnet50_2(pretrained=False, progress=True)
    elif resnet_type == 101:
        return ResNet.resnet101(pretrained=False, progress=True)
    else:  #152
        return ResNet.resnet152(pretrained=False, progress=True)
